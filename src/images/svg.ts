export const chevronSvg = (className: string = ''): string => `
  <svg height="16" width="16" class="${className}" viewBox="0 0 24 24" fill="none">
    <path d="M6.34317 7.75732L4.92896 9.17154L12 16.2426L19.0711 9.17157L17.6569 7.75735L12 13.4142L6.34317 7.75732Z" fill="currentColor" />
  </svg>
`.trim()

export const heartSvg = (className: string = ''): string => `
  <svg height="16" width="16" fill="currentColor" class="${className}" viewBox="0 0 16 16">
    <path d="M4 1c2.21 0 4 1.755 4 3.92C8 2.755 9.79 1 12 1s4 1.755 4 3.92c0 3.263-3.234 4.414-7.608 9.608a.513.513 0 0 1-.784 0C3.234 9.334 0 8.183 0 4.92 0 2.755 1.79 1 4 1z" />
  </svg>
`.trim()

export const swapSvg = (className: string = ''): string => `
  <svg height="16px" width="16px" class="${className}" viewBox="0 0 365.352 365.352" xml:space="preserve" stroke-width="0" transform="rotate(180)">
    <g stroke-width="0" />
...
export const xSvg = (className: string = ''): string => `
  <svg height="16" width="16" fill="currentColor" class="${className}" viewBox="0 0 16 16">
