    ...
    <div>
      <div class='unelevated_form'>
        ...
        <div class='unelevated_saved'>
          <a href='javascript:void 0'><Heart className='heart_save' /></a>
        </div>

        <div class='labels'>
          <a href='javascript:void 0' class='switch'><Swap /></a>
      ...
      <div class='bulk_box'>
        <div class='bulk_results hidden'>
          <div class='filters'>
            <label><input type='checkbox' checked={savedFilters.nonstop} data-filter='nonstop' />{lang.nonstop}</label>
            <label><input type='checkbox' checked={savedFilters.first} data-filter='first' />{lang.first}</label>
            <label><input type='checkbox' checked={savedFilters.business} data-filter='business' />{lang.business}</label>
