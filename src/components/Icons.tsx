...
export const X = ({ className }: IconProps): JSX.Element => (
  <svg height={16} width={16} fill='currentColor' class={className} viewBox='0 0 16 16'>
